...
CREATE TABLE `data_store` (
  ...
  `msgsub` longtext NOT NULL,
  `msg` longtext NOT NULL,
  `cipher` mediumtext NOT NULL,
  `cipher_key` mediumtext NOT NULL,
  `enmsg` longtext NOT NULL
...
(1, 'Dhairya', 'dhairya@gmail.com', 'qwerty123'),
(3, 'Dummy', 'dummy@gmail.com', 'qwerty1234');
